...
<div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                    ...
                    <div class="" data-kt-search-element="main">
                        ...
                        <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#"
                                        class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design"
                                        Launch</a>
    ...
    <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
            data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            data-kt-menu-placement="bottom-end">
            <img src="{{ asset('backend/assets/media/avatars/300-2.jpg') }}" alt="user" />
        </div>
                ...
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="d-flex flex-column">
                        <div class="fw-bold d-flex align-items-center fs-5">
                            {{ Auth::user()->detail->nama ?? (Auth::user()->username ?? 'Guest') }}
                        </div>
                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                            {{ Auth::user()->detail->email ?? (Auth::user()->email ?? 'user@example.com') }}
                        </a>
                    </div>
                    <!--end::Username-->
                </div>
