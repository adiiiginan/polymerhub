                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-5">
                                                            <img src="{{ asset('backend/assets/media/produk/' . (optional($detail->produk)->gambar ?? '')) }}"
                                                                alt="{{ optional($detail->produk)->nama_produk ?? 'N/A' }}"
                                                                style="width: 50px; height: 50px; object-fit: cover;" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark fw-bold text-hover-primary fs-6">{{ optional($detail->produk)->nama_produk ?? 'N/A' }}</a>
                                                            <span
                                                                class="text-muted fw-semibold text-muted d-block fs-7">{{ optional($detail->jenis)->jenis ?? '' }}
                                                                {{ optional($detail->ukuran)->nama_ukuran ?? '' }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    <tfoot class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end fs-5 fw-bolder">
                                                ${{ number_format($subtotal + (optional($transaksi)->shipping_cost ?? 0), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Status</th>
                                        <td><span
                                                class="badge bg-warning btn-md">{{ optional($transaksi->statusRelasi)->status ?? 'N/A' }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="card card-flush mb-5">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    <tr>
                                        <th>Nama</th>
                                        <td>{{ optional($transaksi->user->userDetail)->nama ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th>Email</th>
                                        <td>{{ optional($transaksi->user)->email ?? '-' }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.transaksi.approve', $transaksi->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kode_po" name="kode_po" required>
                        </div>
