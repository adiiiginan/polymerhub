...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('admin.stok-opname.create') }}" class="btn btn-primary mb-3">Tambah Stok Opname</a>
                ...
                <tbody>
                    @foreach ($stokOpnames as $key => $opname)
                        <tr>
                            ...
                            <td>{{ $opname->status }}</td>
                            <td>
                                <a href="{{ route('admin.stok-opname.edit', $opname->id) }}"
                                    class="btn btn-primary btn-sm">Edit</a>
                                <a href="{{ route('admin.stok-opname.show', $opname->id) }}"
                                    class="btn btn-info btn-sm">Detail</a>

                                <form action="{{ route('admin.stok-opname.destroy', $opname->id) }}" method="POST"
                                    class="d-inline"
