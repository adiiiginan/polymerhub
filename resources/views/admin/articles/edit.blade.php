                ...
                <div class="card-body">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                ...
                                <li class="breadcrumb-item text-muted ">
                                    <a href="{{ route('admin.articles.index') }}"
                                        class="text-muted text-hover-primary">Articles</a>
                                </li>
                                <li class="breadcrumb-item">
                                    <span class="bullet bg-gray-500 w-5px h-2px"></span>
                                </li>
                    ...
                    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="indocontent" id="indocontent" class="form-control" rows="10" required>{{ old('indocontent', $article->indocontent) }}</textarea>
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <select name="idcategory" id="idcategory" class="form-control" required>
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ old('idcategory', $article->idcategory) == $category->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="publish" id="publish_yes"
                                    value="1" {{ old('publish', $article->publish) == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="publish" id="publish_no" value="0"
                                    {{ old('publish', $article->publish) == 0 ? 'checked' : '' }}>
