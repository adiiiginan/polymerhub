...
@section('content')
    <div style="--main-color: #1A365D; --accent-color: #5DADE2; --accent-light: #EBF5FB;">
        ...
        <div
            ...
            <h1 style="color: #fff; font-size: 2.5rem; font-weight: 700; margin-bottom: 0.75rem; position: relative;">
                {{ $activeCategory->kategori ?? 'Top Tape' }}
            </h1>
            <p
    ...
    ">
        ...
        ">
            ...
            ">
                                    <svg width="80" height="40" viewBox="0 0 80 50">
                                        <rect x="4" y="10" width="72" height="12" rx="6" stroke="#5DADE2"
                ...
                ">
                    ...
                    ">
                                        ...
                                        <a href="{{ route('id.frontend.produk.show', 1) }}" class="view-options-button"
                                            data-url="{{ route('id.frontend.produk.show', 1) }}"
                                            style="
                        font-size:11px;
                        padding:6px 12px;
                        background:var(--main-color);
        ...
        ">
            ...
            ">
                                    <svg width="80" height="40" viewBox="0 0 80 50">
                                        <rect x="4" y="10" width="72" height="12" rx="6" stroke="#639922"
                                            stroke-width="2" fill="none" />
                                    </svg>
                                </div>
        ...
        ">
            ...
            ">
                                    <svg width="80" height="40" viewBox="0 0 80 50">
                                        <rect x="4" y="10" width="72" height="12" rx="6" stroke="#BA7517"
                                            stroke-width="2" fill="none" />
                                    </svg>
                                </div>
