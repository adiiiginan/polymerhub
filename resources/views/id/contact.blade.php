...
@section('content')
    <div class="max-w-5xl mx-auto bg-white border rounded-lg p-2 shadow-md mt-12 mb-12">
        ...
        @endif
        <form method="POST" action="{{ route('id.contact.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @csrf

            <!-- First Name -->
            <div>
                <label class="block text-sm font-semibold text-red-600">* Nama Depan</label>
                <input type="text" name="nama" class="w-full border rounded px-3 py-2" id="nama" />
            </div>

            <!-- Last Name -->
            <div>
                <label class="block text-sm font-semibold text-red-600">* Nama Belakang</label>
                <input type="text" name="belakang" class="w-full border rounded px-3 py-2" id="belakang" />
            </div>

            <!-- Country -->
            <div>
                <label class="block text-sm font-semibold text-red-600">* Negara</label>
            ...
            <!-- Phone -->
            <div>
                <label class="block text-sm font-semibold text-red-600">* Nomor HP</label>
                <input type="number" name="notlp" class="w-full border rounded px-3 py-2" id="notlp" />
            </div>

            <!-- Company -->
            <div>
                <label class="block text-sm font-semibold text-red-600">* Perusahaan </label>
                <input type="text" name="perusahaan" class="w-full border rounded px-3 py-2" id="perusahaan" />
            </div>

            <!-- Details (Full Width) -->
            <div class="md:col-span-2">
                <label class="block text-sm font-semibold text-red-600">* Catatan</label>
            ...
            <div class="md:col-span-2 text-sm text-gray-700">
                <p class="font-semibold text-blue-800 mb-2">
                    Kami ingin Anda mengetahui secara jelas bagaimana layanan kami bekerja dan mengapa kami memerlukan
                    detail pendaftaran Anda.
                    Harap konfirmasi bahwa Anda telah membaca dan menyetujui syarat-syarat ini sebelum melanjutkan.
                </p>

                <div class="flex items-center mb-2">
                    <input type="checkbox" name="privacy" id="privacy" class="mr-2" />
                    <label for="privacy">
                        Saya Setuju dengan<a href="#" class="text-blue-600 underline">Kebijakan Privasi</a>.
                    </label>
                </div>
                ...
                <div class="flex items-center mb-2">
                    ...
                    <label for="updates">
                        Saya Setuju dengan menerima pembaruan produk (opsional)
                    </label>
                </div>

                <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mt-2" role="alert">
                    <p class="text-xs">
                        Kami ingin menginformasikan Anda tentang pembaruan terbaru kami mengenai produk-produk kami.
                    </p>
                </div>
                <div class="bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md mt-4"
                    ...
                    <div class="flex">
                        ...
                        <div>
                            <p class="font-bold">
                                Informasi Kontak | Mobile 1 : +62 878-2330-9818 | Mobile 2 : +62
                                813-2184-0775
                                | Email : infojns.co.id
                            </p>
                        </div>
