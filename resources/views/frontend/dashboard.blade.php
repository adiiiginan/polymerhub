        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab"
                                    href="#order_custom">Request Quotation<span
                                        class="badge badge-light-success ms-2">{{ $customOrdersCount }}</a>
                            </li>
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab"
                                    href="#order_placed">Order Placed <span
                                        class="badge badge-light-success ms-2">{{ $pendingOrdersCount ?? 0 }}</span></a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                ...
                <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="text-gray-600 mb-1"><strong>Address:</strong>
                                                        {{ $user->detail->alamat ?? 'Alamat tidak tersedia' }}</p>
                                                    <p class="text-gray-600 mb-1"><strong>Courier:</strong> -</p>
                                    ...
                                    <div class="card-body">
                                        <div class="alert alert-warning d-flex align-items-center p-3">
                                            ...
                                            <p class="mb-0 fw-semibold">
                                                Setiap pesanan yang masuk akan direview oleh admin terlebih dahulu.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Tab for Payment Pending -->
                    <div class="tab-pane fade show active" id="payment_pending_page" role="tabpanel">
                                                    ...
                                                    @if ($invoice->kode_inv)
                                                        <div class="d-flex gap-2">
                                                            <a href="{{ route('invoices.show', $invoice->id) }}"
                                                                ...
                                                                <i class="ki-outline ki-eye fs-4 me-2"></i>Lihat Invoice
                                                            </a>

                                                            @if ($invoice->bukti_bayar)
                                                                <span class="badge badge-light-success align-self-center">
                                                                    <i
                                                                        class="ki-outline ki-check-circle fs-4 me-1"></i>Bukti
                                                                    Diupload
                                                                </span>
                                                            @else
                                    ...
                                    <div class="card-body">
                                        <div class="alert alert-success">
                                            ...
                                            <p>Pembayaran untuk pesanan ini telah berhasil dikonfirmasi. Pesanan Anda akan
                                                segera diproses.</p>
                                            <hr>
                                            <p class="mb-0">Untuk informasi lebih lanjut, hubungi customer service kami.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="d-flex align-items-center mb-5">
                                                <div class="d-flex align-items-center flex-grow-1">
                                                    <div class="symbol symbol-45px me-5">
                                                        @if ($order->is_request == 1)
                                                            <img src="{{ asset('backend/assets/media/produk/' . $order->details->first()->produk->gambar) }}"
                                                                alt="" />
                                                        @else
                                                            <img src="{{ asset('backend/assets/media/produk/no-image.png') }}"
                                                                alt="No Image" />
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="#"
                                                            class="text-gray-900 text-hover-primary fs-6 fw-bold">{{ $order->idtransaksi }}</a>
                                                        <span class="text-gray-500 fw-bold">Requested on
                                                            {{ $order->created_at->format('d M Y, H:i') }}</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex my-2">
                                                    <span class="badge badge-light-info">Custom</span>
                                                    @if ($order->statusRelasi)
                                                        <span
                                                            class="badge badge-light-{{ $order->status == 4 ? 'success' : ($order->status == 1 ? 'warning' : 'primary') }} ms-2">{{ $order->statusRelasi->status ?? 'Unknown' }}</span>
                                                    @else
                                                        <span class="badge badge-light-secondary ms-2">Status:
                                                            {{ $order->status }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            @foreach ($order->details as $detail)
                                                <div class="d-flex align-items-center mb-2">
                                                    <div class="d-flex">
                                                        <span
                                                            class="text-gray-800 fw-bold">{{ optional($detail->produk)->nama_produk ?? 'Produk tidak tersedia' }}</span>
                                                        <span class="text-gray-600 ms-2">|| Qty:
                                                            {{ $detail->qty }}</span>
                                                        <span class="text-gray-600 ms-2">|| Jenis:
                                                            {{ data_get(json_decode($detail->jenis), 'jenis') }}</span>
                                                        <span class="text-gray-600 ms-2">|| Ukuran:
                                                            {{ data_get(json_decode($detail->ukuran), 'nama_ukuran') }}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                            @if ($order->request)
                                                <div class="d-flex align-items-center mb-2">
                                                    <div class="d-flex">
                                                        <span class="text-gray-600 fw-bold">Request Details:</span>
                                                        <span
                                                            class="text-gray-600 ms-2">{{ $order->request->deskripsi ?? 'No description' }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                        ...
                        <div class="row g-5 g-xxl-8">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-5 mb-xxl-8">
                                    <div class="card-body">
                                        <div class="alert alert-info">
                                            <h4 class="alert-heading">Pesanan Sedang Dikirim</h4>
                                            <p>Pesanan Anda sedang dalam proses pengiriman. Anda akan menerima notifikasi
                                                ketika
                                                pesanan tiba.</p>
                                            <hr>
                                            <p class="mb-0">Untuk informasi lebih lanjut, hubungi customer service kami.
