            ...
            <div class="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center py-20 md:py-32">
                <div class="text-center md:text-left">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <a href="#products"
                            class="inline-block bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="relative w-full h-[300px] sm:h-[360px] md:h-[420px] lg:h-[480px]">
                    <div
                        class="absolute inset-0 bg-blue-200 rounded-full transform -rotate-12 scale-105 blur-2xl opacity-40">
                    </div>
            ...
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white p-8 rounded-xl shadow-sm border border-slate-200 text-center">
                        <div
                            class="flex items-center justify-center h-20 w-20 rounded-full bg-blue-100 text-blue-600 mx-auto mb-6">
        ...
        <section class="py-24 bg-white" id="products">
            <div class="container mx-auto px-6">
                <div class="text-left mb-16 max-w-2xl">
                    <span class="text-blue-600 font-semibold tracking-wider uppercase">Our Brochure</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-slate-50 rounded-xl overflow-hidden group border border-slate-200/80">
                        <div class="p-8">
                            ...
                            <a href="#"
                                class="font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-2">
            ...
            <div class="container mx-auto px-6">
                <div
                    ...
                    <div class="flex-shrink-0">
                        <a href="#"
                            class="inline-block bg-blue-500 text-white font-bold px-10 py-4 rounded-lg hover:bg-blue-600 transition-colors duration-300 shadow-lg">
