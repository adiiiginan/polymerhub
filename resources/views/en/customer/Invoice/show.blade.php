        ...
        <div class="invoice-details">
                ...
                <div class="customer-box">
                    <div class="info-row">
                        ...
                        <span class="info-value">:
                            <b>{{ $invoice->transaksi->address->nama ?? 'Nama Pelanggan' }}
                            </b>
                        </span>
                    </div>
                    <div class="info-row">
                        ...
                        <span class="info-value">:
                            {{ $invoice->transaksi->address->alamat ?? 'Alamat Pelanggan' }}
                        </span>
                        </span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Tel.</span>
                        <span class="info-value">: {{ $invoice->transaksi->address->phone ?? '' }}</span>
                    </div>
                    <div class="info-row">
            ...
            <div class="payment-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: OCBC NISP</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Alamat</span>
                    <span class="info-value">: Setiabudi Bandung</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: 0128.0000.2177 (IDR)</span>
                </div>
                <br>
                <div class="info-row">
                    <span class="info-label">Nama Acc</span>
