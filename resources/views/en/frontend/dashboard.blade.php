                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <p class="text-gray-600 mb-1"><strong>Courier:</strong>
                                                            {{ $order->items->shipping_service }}</p>
                                                        <a href="#" class="text-blue-500 hover:underline">Track
                                                            Order</a>
                                                    </div>
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <div class="d-flex justify-content-between items-center mt-2">
                                                ...
                                                @if ($order->shipment && $order->shipment->tracking_number)
                                                    <a href="https://www.fedex.com/fedextrack/?trknbr={{ $order->shipment->tracking_number }}"
                                                        target="_blank" class="btn btn-primary btn-sm">Track
                                                        Order</a>
                                                @endif
                                            </div>
                                            @if ($order->status == 3)
